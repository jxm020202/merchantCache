...
import (
	"fmt"
	"log"
	"merchantcache/internal/abn/abr"
	"merchantcache/internal/abn/config"
	"merchantcache/internal/abn/data"
...
func main() {
	...
	processor := data.NewProcessor(cfg.OutputFile, data.SupabaseConfig{
		URL:   cfg.SupabaseURL,
		Key:   cfg.SupabaseKey,
	...
	if err := processor.SyncSupabase(); err != nil {
